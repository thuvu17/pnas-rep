...
data_4k  <- GetAssayData(part1.subset, assay = "RNA", slot = "data.subset_4k")
data_8k  <- GetAssayData(part1.subset, assay = "RNA", slot = "data.subset_8k")
data_gdt <- GetAssayData(part1.subset, assay = "RNA", slot = "data.gdt")
...
tsne_13k <- Embeddings(part1.subset, "tsne")
